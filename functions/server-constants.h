...
#define ADMIN_LOGIN_SUCCESS "\n **************************************( Welcome!!  Login as Admin successful )**************************************\n\n "

// ADMIN MENU
#define ADMIN_MENU "What action do you want to perform?\n\n1. Get Customer Details\n2. Get Account Details\n3. Get Transaction details\n4. Add Account\n5. Delete Account\n6. Modify Customer Information\nPress any other key to logout"
...
#define ADMIN_ADD_CUSTOMER_NAME "\nWhat is the customer's name?"
#define ADMIN_ADD_CUSTOMER_GENDER "\nWhat is the customer's gender?\nEnter M for male, F for female and O for others"
#define ADMIN_ADD_CUSTOMER_AGE "\nWhat is the customer's age?"
#define ADMIN_ADD_CUSTOMER_AUTOGEN_LOGIN "\n\n**************************************( Congratulations Your Account has been created )**************************************\n\nThe autogenerated login ID for the customer is : "
#define AUTOGEN_PASSWORD "Password" // append to end of next string macro
...
// ADD ACCOUNT
#define ADMIN_ADD_ACCOUNT_TYPE "What type of account do you want?\n\n 1.Regular account \t\t2.Joint account"
...
#define PASSWORD_CHANGE_NEW_PASS_INVALID "The new password and the re-entered passwords don't seem to pass!^"
